...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('public/sms/assets/css/pace-theme-flat-top.css') }}">
  ...
  <body class="skin-blue fixed  hold-transition sidebar-mini pace-primary">
  
    <div class="wrapper">

      
      @include('backend.header.'.$role)
      <!-- Left side column. contains the logo and sidebar -->      
      @include('backend.sidebar.'.$role)
    ...
    <script src="{{ asset('public/sms/assets/js/pace.min.js') }}"></script>
    <script>
        @if(Session::has('success-text'))
            toastr.success("{{Session::get('success-text')}}");
        @endif
        @if(Session::has('info-text'))
            toastr.info("{{Session::get('info-text')}}"); 
        @endif
        @if(Session::has('error-text'))
            toastr.error("{{Session::get('error-text')}}");
        @endif
        @if(Session::has('warning-text'))
            toastr.warning("{{Session::get('warning-text')}}");
        @endif
    </script>
