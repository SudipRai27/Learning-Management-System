...
@endsection
@section('content')
<div class="form-header"><p class="form-header">Create Class</p></div>
<form action="{{route('create-class-post')}}" method="POST" enctype="multipart/form-data" >
	<br>
		...
		<div class="col-sm-6">
			<div class="form-group">
	            ...
	            <select class="form-control select2 @if($errors->first('teacher_id')) form-error @endif" name="teacher_id" id="teacher_id">
	            	<option value="">Select Subject And Class Type First</option>
	            </select>
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="form-group">
				...
				<input type="time" name= "start_time" id="start_time" class="form-control @if($errors->first('start_time')) form-error @endif" value="{{Input::old('start_time')}}" />
		...
		<div class="col-sm-6">
			<div class="form-group">
	    		...
	    		<input type ="time" name ="end_time" id="end_time" class="form-control demo-non-form @if($errors->first('end_time')) form-error @endif" value="{{Input::old('end_time')}}" />	    
...
<input type="hidden" name="" id="old_teacher_id" value="{{Input::old('teacher_id')}}">
<input type="hidden" name="" id="old_room_id" value="{{Input::old('room_id')}}">
{{ csrf_field() }}
</form>
@endsection
@section('custom-js')
...
<script type="text/javascript">
	...
	$(document).ready(function (){
		...
		if($('#type').val() || $('#subject_id').val())
		{
			updateTeacherListByClassType($('#session_id').val(), $('#subject_id').val(),$('#type').val());
