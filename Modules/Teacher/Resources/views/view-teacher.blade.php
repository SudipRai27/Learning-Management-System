		...
		<div class="col-sm-4">
			...
			<div class="profile-detail">
				...
				<div class="second-head" style="text-align:center">
					<span style="color:#333">teacher ID: {{$teacher->teacher_id}}</span> 
				</div>
				<ul>
					<li>
						<label> Full Name: </label><span class="text-green"> {{$teacher->name}}</span>
					</li>
					<li>
						<label>Email:</label> <span class="text-green"> {{$teacher->email}}</span>
					</li>
					<li>
						<label>DOB:</label> <span class="text-green">{{$teacher->dob}}</span>
					</li>				
					<li>
						<label>Address:</label> <span class="text-green"> {{$teacher->address}} </span>
					</li>
					<li>
						<label>Phone Number:</label> <span class="text-green">  {{$teacher->phone}}</span>
					</li>
					<li>
						<label>Emergency Contact Name: </label> <span class="text-green"> {{$teacher->emergency_contact_name}} </span>
					</li>
					<li>
						<label>Emergency Contact Information: <span class="text-green"> {{$teacher->emergency_contact_number}} </span>
					</li>				
				</ul>
			</div>
		</div>
