<div class="row">
	@include('backend.partials.session-subject-partial')
</div>						
			...
			<table class="table table-bordered table-hover" id="class-table">     
				...
				<tbody>
					...
					<tr>
						...
						<td>											
							<a href = "{{route('view-attendance', [$selected_session_id, $selected_subject_id,$record->class_id])}}" data-lity><button data-toggle="tooltip" title="" class="btn btn-warning btn-flat" type="button" data-original-title="Update"> View Attendance<i class="fa fa-fw fa-edit"></i></button></a>							
						</td>
					</tr>
					@endforeach								
				</tbody>       								
